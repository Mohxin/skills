  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-between px-5 h-topbar border-b border-neutral-800">
        ...
        <button
          className="lg:hidden p-1 rounded hover:bg-neutral-800 transition-colors"
          onClick={onClose}
      ...
      <nav className="flex-1 overflow-y-auto py-3 px-2 space-y-4">
        {navGroups.map((group) => (
          <div key={group.label}>
            <p className="px-3 mb-1 text-[10px] font-semibold uppercase tracking-wider text-neutral-500">
              {group.label}
            </p>
              ...
              {group.items.map((item) => (
                <li key={item.path}>
                  ...
                  >
                    {({ isActive }) => (
                      <>
                        <span className={isActive ? 'text-brand-400' : ''} aria-hidden="true">
                          {item.icon}
                        </span>
                        {item.label}
                      </>
      ...
      <div className="border-t border-neutral-800 p-3 space-y-2">
        <select
          ...
          className="w-full px-2 py-1.5 text-xs rounded-md bg-neutral-800 border border-neutral-700 text-neutral-300 focus:outline-none focus:ring-2 focus:ring-brand-500"
