...
const commands = [
  ...
  { label: 'Go to Planner', icon: 'M9 6.75V15m6-6v8.25m.503-11.995l4.875 2.438c.41.205.672.624.672 1.083v8.448c0 .459-.262.878-.672 1.083l-4.875 2.438a1.125 1.125 0 01-1.006 0L9.503 18.245a1.125 1.125 0 00-1.006 0l-4.875 2.438A1.125 1.125 0 012 19.677V11.23c0-.459.262-.878.672-1.083l4.875-2.438a1.125 1.125 0 011.006 0l4.994 2.497c.316.158.69.158 1.006 0z', action: '/planner', shortcut: '' },
